...
namespace UniRx
{
    public static partial class Observable
    {
        ...
        ///     like generator.
        /// </summary>
        public static IObservable<Unit> QuickObservable(Action<IObserver<Unit>> subscribe)
        {
            return Create<Unit>(obs =>
            {
                obs.OnNext(default);
                subscribe(obs);
        ...
        public static IObservable<T> Simple<T>(Func<T> generator)
        {
            return Empty(Unit.Default).Select(_ => generator());
        }
