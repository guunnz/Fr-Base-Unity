...
#pragma warning disable CS0618
        ...
        private IEnumerator TestNewCustomYieldInstruction()
        {
            ...
            yield return Observable.Timer(TimeSpan.FromSeconds(1), Scheduler.MainThreadIgnoreTimeScale)
                .ToYieldInstruction();
            ...
            yield return this.ObserveEveryValueChanged(x => x.transform).FirstOrDefault(x => x.position.y >= 100)
                .ToYieldInstruction();
        }
#if UNITY_2018_3_OR_NEWER
