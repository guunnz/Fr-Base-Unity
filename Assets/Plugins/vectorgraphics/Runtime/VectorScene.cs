...
namespace Unity.VectorGraphics
{
    ...
    ///     Radial fills are centered in the element's bounding box. Its radii are half the bounding box dimensions in each
    ///     direction.
    ...
    public class Stroke
    {
        ...
        public Color Color
        {
            ...
            set => Fill = new SolidFill {Color = value};
        }
        ...
        public Matrix2D FillTransform { get; set; } = Matrix2D.identity;
