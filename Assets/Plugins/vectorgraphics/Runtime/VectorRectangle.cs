...
namespace Unity.VectorGraphics
{
    public partial class VectorUtils
    {
        ...
        public static BezierContour BuildRectangleContour(Rect rect, Vector2 radiusTL, Vector2 radiusTR,
            Vector2 radiusBR, Vector2 radiusBL)
        {
            ...
            {
                seg = MakePathLine(new Vector2(width, radiusTR.y),
                    new Vector2(width, radiusTR.y + rightSegmentSize))[0];
                segments.Add(seg);
            }
            ...
            {
                seg = MakePathLine(new Vector2(width - radiusBR.x, height),
                    new Vector2(width - (radiusBR.x + bottomSegmentSize), height))[0];
                segments.Add(seg);
            }
