...
namespace Unity.VectorGraphics
{
    ...
    {
        internal static Object MakeVectorImageAsset(IEnumerable<VectorImageVertexBridge> vertices,
            IEnumerable<ushort> indices, Texture2D atlas, IEnumerable<GradientSettingsBridge> settings, Vector2 size)
        {
        ...
        internal static bool GetDataFromVectorImage(Object o, ref Vector2[] vertices, ref ushort[] indices,
            ref Vector2[] uvs, ref Color[] colors, ref Vector2[] settingIndices, ref GradientSettingsBridge[] settings,
            ref Texture2D texture, ref Vector2 size)
        {
            ...
            settingIndices =
                vi.atlas != null ? vi.vertices.Select(v => new Vector2(v.settingIndex, 0)).ToArray() : null;
            texture = vi.atlas;
            size = vi.size;
