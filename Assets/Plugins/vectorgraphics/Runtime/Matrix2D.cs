...
namespace Unity.VectorGraphics
{
    ...
    public struct Matrix2D
    {
        ...
        public static Matrix2D zero { get; } = new Matrix2D(new Vector2(0, 0), new Vector2(0, 0), new Vector2(0, 0));

        /// <summary>Returns the identity matrix (read-only).</summary>
        /// <returns>The identity matrix</returns>
        public static Matrix2D identity { get; } =
            new Matrix2D(new Vector2(1, 0), new Vector2(0, 1), new Vector2(0, 0));
