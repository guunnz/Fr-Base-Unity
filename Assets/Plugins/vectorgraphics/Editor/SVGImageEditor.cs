...
namespace Unity.VectorGraphics
{
    ...
    public class SVGImageEditor : GraphicEditor
    {
        ...
        private GUIContent m_PreserveAspectContent;
        ...
        private static GameObject GetOrCreateCanvasGameObject()
        {
            ...
            if (canvas == null) canvas = CreateCanvasGameObject();
        ...
        private static void PlaceUIElementRoot(GameObject element, MenuCommand menuCommand)
        {
            ...
            if (parent == null) parent = GetOrCreateCanvasGameObject();
            if (parent.GetComponentInParent<Canvas>() == null)
            {
                // Create canvas under context GameObject,
                // and make that be the parent which UI element is added under.
                var canvas = CreateCanvasGameObject();
        ...
        {
            var go = new GameObject("SVG Image");
