...
namespace Snapshots
{
    ...
    [RequireComponent(typeof(SnapshotGenericObject))]

    public class SnapshotAvatar : MonoBehaviour, IGetSnapshotGameObject
    {
        ...
        private SnapshotGenericObject snapshotGenericObject;
        ...
        void Awake()
        {
            ...
            snapshotGenericObject = GetComponent<SnapshotGenericObject>();
        }
        ...
        public void CreateSnaphot(Action<bool, int, Sprite> callback, AvatarCustomizationData avatarCustomizationData)
        {
            ...
            snapshotGenericObject.SetSnapshot(this, position, rotate, scale, sizeFactor, widthTexture, heightTexture, (bool flag, int idSnapshot, Sprite sprite) =>
            {
                ...
                SetAlphaImage(imageContainer.gameObject, 1);
                if (callback != null)
                {
        ...
        public void ShowLoader()
        {
            ...
            SetAlphaImage(imageContainer.gameObject, 0);
        }
