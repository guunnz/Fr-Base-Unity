...
namespace Socket
{
    public class IncomingEventMinigameStatus : AbstractIncomingSocketEvent
    {
        public override string EventType => SocketEventTypes.MINIGAME_INVITE_STATUS_UPDATE;
        ...
        public IncomingEventMinigameStatus(JObject message) : base(message)
        {
            try
            {
                try
