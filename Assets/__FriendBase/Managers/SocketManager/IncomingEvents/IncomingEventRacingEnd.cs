...
namespace Socket
{
    public class IncomingEventRacingEnd : AbstractIncomingSocketEvent
    {

        public string firebaseUid;
        public string userId;
        public override string EventType => SocketEventTypes.RACING_END;

        public IncomingEventRacingEnd(JObject message) : base(message)
        {
            try
            {
                try
