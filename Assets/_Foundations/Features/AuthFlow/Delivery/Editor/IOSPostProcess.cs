...
using AuthFlow.Delivery.AppleAuth.Editor;
using UnityEditor;
...
namespace AuthFlow.Delivery
{
    public class IOSPostProcess
    {
        ...
        public static void OnPostProcessBuild(BuildTarget target, string path)
        {
            ...
            ProjectCapabilityManager manager = new ProjectCapabilityManager(projectPath, "Entitlements.entitlements",
                null,
    ...
    namespace AppleAuth.Editor
{
    public static class ProjectCapabilityManagerExtension
    {
        ...
        public static void AddSignInWithAppleWithCompatibility(this ProjectCapabilityManager manager, string unityFrameworkTargetGuid
 = null)
        {
 ...
 managerType.GetMethod("GetOrCreateEntitlementDoc", NonPublicInstanceBinding);
            ...
            if (project != null)
            {
                ...
                var capabilityType =
 constructorInfo.Invoke(new object[] { "com.apple.developer.applesignin.custom", true, string.Empty, true }) as PBXCapabilityType;
