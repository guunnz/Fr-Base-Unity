...
namespace Graph._3rdparty.xNode.Scripts
{
    /// <summary>
    ...
    public abstract class Node : ScriptableObject
    {
        ...
        public enum TypeConstraint
        {
            ...
            /// <summary>
            ///     Allow connections where output value type is assignable from input value or input value type is assignable
            ///     from output value type
            /// </summary>
            InheritedAny
        }
        ...
        [Obsolete("Use DynamicPorts instead")] public IEnumerable<NodePort> InstancePorts => DynamicPorts;
        ...
        public void ClearDynamicPorts()
        {
            ...
            foreach (var port in dynamicPorts) RemoveDynamicPort(port);
        }
