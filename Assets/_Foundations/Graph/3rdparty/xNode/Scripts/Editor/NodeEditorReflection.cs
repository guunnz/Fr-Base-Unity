...
namespace Graph._3rdparty.xNode.Scripts.Editor
{
    ...
    public static class NodeEditorReflection
    {
        ...
        {
            if (nodeTint == null) CacheAttributes<Color, Node.NodeTintAttribute>(ref nodeTint, x => x.color);
        ...
        {
            if (nodeWidth == null) CacheAttributes<int, Node.NodeWidthAttribute>(ref nodeWidth, x => x.width);
