...
namespace Adinmo {
	...
	public class AdinmoTexture : AdinmoReplace {
		...
		////////////////////////////////////////////////////////////////////////////////////
		protected override void ApplyTextureToImage(AdinmoBaseTexture id, Texture t)
		{
            if (id.MediaType != Flatbufs.MediaType.Video)
            {
                if (m_rawImage != null)
                {
                ...
                if (id.ImageSprite == null)
                    id.ImageSprite = Sprite.Create((Texture2D)t, new Rect(0, 0, t.width, t.height), new Vector2(.5f, .5f), 100.0f, 0, SpriteMeshType.FullRect);
